...
-- Optional: keep authenticated users unrestricted read access (should already exist)
-- Uncomment if needed
-- drop policy if exists "Allow authenticated read prayers" on public.prayers;
-- create policy "Allow authenticated read prayers"
--   on public.prayers
--   for select
--   to authenticated
--   using (true);